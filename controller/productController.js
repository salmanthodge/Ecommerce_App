...
export const productPhotoController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      messege: "Error while getting  product photo",
      error,
    });
  }
};
...
export const productFilterController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      messege: "Error while Filtering product",
      error,
    });
  }
};
...
export const productCountController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      messege: "Error in product count",
      error,
    });
  }
};
...
export const productListController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      messege: "Error in per page ctrl",
      error,
    });
  }
};
...
export const searchProductController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      messege: "Error in searching product API",
    });
  }
};
...
export const relatedProductcontroller = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      messege: "Error while getting related products",
    });
  }
};
